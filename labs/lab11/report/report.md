...
1. Первая программа-анализирует командную строку с ключами 
...
4. Четвертая программа-файл запаковывает измененные неделю или больше назад
